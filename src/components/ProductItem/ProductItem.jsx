...
function ProductItem(props) {
   ...
   const {categoryName,id,name,price,currency,image,addToCart,user,favorites,addToFavorites,removeFromFavorites} = props;
  ...
  return (
      ...
      <div className="product-item col-12 col-lg-4 mb-3 d-flex flex-column align-items-center">
              ...
              <div className='empty-heart'>
                ...
                user 
                ? 
                    checkFavoriteList(favorites) ? <FullHeart onClick={()=>{
                      removeFromFavorites({
                        products: {
                          id,
                        }
                ...
                :
                 <EmptyHeart onClick={()=>{openLoginModal()}}/>
              }

              </div>

              <Link to={`/product/${id}`} style={{textAlign:'center',color:'inherit'}}>
